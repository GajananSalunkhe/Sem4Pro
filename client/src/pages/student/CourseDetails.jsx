...
const CourseDetails = () => {
  ...
  const {allCourses, calculateRating, calculateNoOfLectures, calculateCourseDuration, calaculateChapterTime, currency} = useContext(AppContext)
    ...
    justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      <div className='max-w-xl z-10 text-gray-500'>
        ...
        {/* review and retings */}
          ...
          <p>Course by <span className='text-blue-600 underline'> Unique Developers</span></p>
            ...
            <div className='pt-5'>
              {courseData.courseContent.map((chapter, index)=>(
                <div key={index} className='border border-gray-300 bg-white mb-2 rounded'>
                  <div className='flex items-center justify-between px-3 py-4 cursor-pointer select-none'
                    ...
                    <p className='text-sm md:text-default'>{chapter.chapterContent.length} lecture - {calaculateChapterTime(chapter)}</p>
                  </div>
      ...
      <div className='max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white
        ...
        <div className='p-5'>
          ...
          <div className='flex gap-3 items-center pt-2'>
            ...
            <div className='flex items-center text-sm md:text-default gap-4 pt-2 md:pt-2 text-gray-500'>
              ...
              <div className='pt-6'>
                ...
                <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
                  ...
                  <li>Downloadable resourses and source code </li>
