  ...
  return (
    <div 
      ...
      <h1 className='md:text-home-heading-large text-home-heading-small relative font-bold text-gray-800 max-w-3xl mx-auto'>Empower your future with the courses designed to 
        ...
        <p className='md:block hidden text-gray-500 max-w-2xl mx-auto'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Et explicabo odit voluptatum quo vel, voluptates nulla magnam sit, 
          vero consequatur maiores eveniet nihil at quasi quod corporis ipsa eos totam.</p>

          <p className='md:hidden text-gray-500 max-w-sm mx-auto'>
              We bring togehter worldclass to help you to achieve your professional goals            
          </p>
         <SearchBar /> 
    </div>
  ) 
